...
- ยังไม่มี UI ใดๆ เรียกใช้ฟังก์ชันเหล่านี้จริง — มีแค่ `frontend/js/gameApi.js`
  เป็น wrapper เตรียมไว้ ยังไม่ได้ต่อเข้ากับหน้าจอไหน (เป็นไปตามสโคปเฟสนี้ที่
  บอกว่า "testable via basic UI/console" — เลือกทดสอบผ่าน SQL โดยตรงแทน
  เพราะครอบคลุมและแม่นยำกว่า console เปล่าๆ)
